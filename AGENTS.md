...
│   ├── map/              @browser.style/map — <ui-map>, clustered keyless-raster maps
...
| `docs/llms-txt.md` | `llms.txt`, markdown alternates, the ARD manifest in `.well-known/` and the crawler policy behind `robots.txt` |
