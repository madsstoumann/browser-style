...
Rendered reference: [`demo/schema.raw.html`](../demo/schema.raw.html), the no-structured-data
twin of `demo/schema.html`, generated by `node ui/card/demo/schema.raw.build.js`.
