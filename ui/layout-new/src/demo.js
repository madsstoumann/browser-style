/**
 * @browser.style/layout - Demo Files Generator
 * Generates HTML demo files showcasing layout patterns
 */
...
/**
 * Generate index HTML listing all demos
 */
...
/**
 * Build all demo files
 *
 * @param {string} layoutsDir - Path to layouts folder
 * @param {string} outputDir - Path to output dist folder
 * @returns {number} Number of demo files generated
 */
export function buildDemoFiles(layoutsDir, outputDir) {
	...
	for (const file of layoutFiles) {
		...
		// Skip overflow (it's not a regular layout type)
