...
class WebConfigColor extends HTMLElement {
	...
	async connectedCallback() {
		...
		await localCss.replace(`
			...
			legend {
				font-family: var(--web-config-ff-sans);
				font-size: small;
			...
			input[type="radio"]:checked {
				border-color: var(--web-config-accent-dark);
				box-shadow: 0 0 0 2px var(--web-config-accent);
			}
...
customElements.define('web-config-color', WebConfigColor);
