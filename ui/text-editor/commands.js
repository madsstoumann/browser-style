export const commands = [
	...
	*/
	...
	},
	{
		...
		fn: () => {
			const embedID = prompt('Enter a Vimeo Embed ID:', '70591644')
	...
	{
		key: 'iframe',
		icon: `M3 5m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v10a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z,M6 8h.01,M9 8h.01`,
		fn: () => {
			const url = prompt('Enter an Iframe URL:', 'https://')
			if (url) document.execCommand('insertHTML', false, `<iframe width="100%" height="500" src="${url}" allow="accelerometer; autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe>`)
		},
		title: 'Insert Iframe'
	},
	{
		...
		fn: () => {
			const url = prompt('Enter a CodePen URL:', 'https://codepen.io/stoumann/pen/KKbGJqd')
	...
	},
	{
		...
		fn: () => {
			const embedID = prompt('Enter a JSFiddle Embed ID:', 'ey0q3aLb/2')
