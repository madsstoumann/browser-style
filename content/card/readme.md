...
For complete Umbraco CMS implementation details including document types, compositions, property editors, and deployment strategies, see the dedicated [Umbraco Implementation Guide](docs/umbraco.md).
````