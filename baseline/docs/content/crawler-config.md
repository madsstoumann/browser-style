...
- [Vercel: robots.txt](../guides/vercel.md#robotstxt) — Edge Config + Next.js route handler
- [Cloudflare: robots.txt](../guides/cloudflare.md#robotstxt) — KV + Worker fetch handler
...
- [Vercel: manifest.json](../guides/vercel.md#manifestjson) — Edge Config + site icon merge
- [Cloudflare: manifest.json](../guides/cloudflare.md#manifestjson) — KV + site icon merge
...
- [Vercel: llms.txt](../guides/vercel.md#llmstxt--llms-fulltxt) — prebuild script + static files
- [Cloudflare: llms.txt](../guides/cloudflare.md#llmstxt--llms-fulltxt) — prebuild + Pages/R2 static assets
