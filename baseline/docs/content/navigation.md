...
- [Vercel: Navigation](../guides/vercel.md#navigation) — `unstable_cache` with tag `navigation`, invalidated by `revalidateTag('navigation')`
- [Cloudflare: Navigation](../guides/cloudflare.md#navigation) — full resolved tree written to KV on webhook
