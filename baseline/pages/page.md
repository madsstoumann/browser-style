...
- [Vercel: Pages (ISR)](./vercel.md#pages-isr) — `revalidateTag('page:{slug}')` for instant ISR revalidation
- [Cloudflare: Pages](./cloudflare.md#pages) — KV write on webhook, Worker reads from KV
