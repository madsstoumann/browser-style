...
- [**Editor Roles**](./editor-roles.md) — Role-based access control: 🔴 Admin, 🟠 Site Editor, 🟢 Content Editor, 🔵 Translator — mapped to CMS-native permissions
...
- [**Vercel (Next.js)**](./vercel.md) — Edge Config, route handlers, middleware, ISR
- [**Cloudflare (Workers / Pages)**](./cloudflare.md) — Workers KV, fetch handlers, Cache API

## Implementation Plans

Architecture plans and setup checklists.

- [**Webhook & Edge Delivery**](./webhook.edge.md) — Architecture plan: webhooks, edge stores, and generated files
- [**Markdown Endpoints**](./markdown-endpoints.md) — Serve pages as clean markdown for LLM consumption
