...
|--------|-----|-------------|
| editor-card | `/cms/integrations/umbraco/editor-card/` | Content Card editor |
| editor-csp | `/cms/integrations/umbraco/editor-csp/` | CSP policy editor |
| editor-manifest | `/cms/integrations/umbraco/editor-manifest/` | PWA manifest editor |
| editor-robots | `/cms/integrations/umbraco/editor-robots/` | robots.txt editor |
| editor-security | `/cms/integrations/umbraco/editor-security/` | security.txt editor |
...
2. Create a new Data Type for each widget you want to use:
   ...
   - Property Editor: Select "Editor Card" (or the appropriate editor)
...
|--------|----------------|
| Content Card | `https://browser.style/cms/integrations/umbraco/editor-card/` |
| CSP | `https://browser.style/cms/integrations/umbraco/editor-csp/` |
| Manifest | `https://browser.style/cms/integrations/umbraco/editor-manifest/` |
| Robots | `https://browser.style/cms/integrations/umbraco/editor-robots/` |
| Security | `https://browser.style/cms/integrations/umbraco/editor-security/` |
