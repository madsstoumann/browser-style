# Editor Taxonomy - Contentful App
...
3. Fill in the app details:
   - **App name**: `Editor Taxonomy`
   - **App URL**: `https://browser.style/cms/integrations/contentful/taxonomy/`
...
### App doesn't load
1. Check the URL is correct: `https://browser.style/cms/integrations/contentful/taxonomy/`
...
- [Editor Taxonomy Component](https://browser.style/cms/editors/taxonomy/) - The underlying web component
