# Editor Robots - Internal Architecture

## Overview

Editor Robots is a **web component for editing robots.txt files** with a visual interface for managing crawler permissions, sitemaps, and advanced directives. It parses existing robots.txt files and generates RFC 9309 compliant output.

**Component Type:** Web Component (Custom Element)

**Tag Name:** `editor-robots`
...
**Lines 15-1108:** `EditorRobots extends HTMLElement`

**Registration:** Line 1108: `customElements.define('editor-robots', EditorRobots);`
...
```html
<editor-robots lang="en"></editor-robots>

<script type="module">
  import '@browser.style/editor-robots';

  const editor = document.querySelector('editor-robots');
...
```html
<editor-robots src="/robots.txt"></editor-robots>
```
