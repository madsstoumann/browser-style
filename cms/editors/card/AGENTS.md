...
Editor Card is a **web component for editing Content Card data models** with a visual schema-driven form interface. It dynamically generates form fields based on JSON schemas and supports nested objects, arrays, and form association.

**Component Type:** Web Component (Custom Element)

**Tag Name:** `editor-card`
...
**Lines 4-323:** `EditorCard extends HTMLElement`

**Registration:** Line 323: `customElements.define('editor-card', EditorCard);`
