# Editor Manifest - Internal Architecture

## Overview

Editor Manifest is a **web component for editing Web App Manifest files**. It provides a form-based UI for configuring PWA settings with live JSON output and form-association support for integration with native HTML forms.

**Package Type:** Web Component (Custom Element)

**Tag Name:** `editor-manifest`
...
```
<form>
  <editor-manifest name="manifest"></editor-manifest>
...
**Lines 5-244:** `EditorManifest extends HTMLElement`

**Registration:** Line 244: `customElements.define('editor-manifest', EditorManifest);`
...
| `adoptSharedStyles` | 3 | `@browser.style/editor-shared` | Shared CSS |
| `captureOpenDetailsState` | 3 | `@browser.style/editor-shared` | Accordion persistence |
| `createTranslator` | 3 | `@browser.style/editor-shared` | i18n function |
| `restoreOpenDetailsState` | 3 | `@browser.style/editor-shared` | Accordion persistence |
| `setState` | 3 | `@browser.style/editor-shared` | State management |
...
```html
<editor-manifest lang="en"></editor-manifest>

<script type="module">
  import '@browser.style/editor-manifest';

  const manifest = document.querySelector('editor-manifest');
...
```html
<editor-manifest value='{"name":"My App","display":"standalone"}'></editor-manifest>
```
