...
This package has been refactored to a factory-based approach. It no longer provides a `<editor-taxonomy>` web component.

## Installation

```bash
npm install @browser.style/editor-taxonomy @browser.style/auto-suggest
```
...
2.  **JavaScript**: Import the factory and a parser. Then, call the factory with the element and your options.
    ...
    ```javascript
    import { createTaxonomySelector, googleTaxonomyParser } from '@browser.style/editor-taxonomy';
...
<script type="module">
  import { createTaxonomySelector } from '@browser.style/editor-taxonomy';
  import '@browser.style/auto-suggest';
