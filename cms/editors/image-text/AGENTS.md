...
| Property | Value |
|----------|-------|
| Custom Element | `<editor-image-text>` |
...
```bash
npm install @browser.style/editor-image-text
```

## Usage

```html
<editor-image-text id="editor" preset="alttext"></editor-image-text>

<script type="module">
  import '@browser.style/editor-image-text';
...
3. **Usage:** `<editor-image-text preset="newpreset">`
...
├── src/
│   └── index.js    # <editor-image-text> web component
