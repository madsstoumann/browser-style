...
styles.replaceSync(`
	...
	[data-token-group] {
		display: grid;
		gap: var(--editor-tokens-gap);
		grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));
		margin-block-start: var(--editor-tokens-gap);
	}
	[data-level="0"] {
		& > summary {
			color: #555;
			...
			font-weight: 500;
			padding-inline: var(--editor-tokens-gap);
			@media (hover: hover) {
	...
	summary {
		...
		padding-block: var(--editor-tokens-gap);
...
export default class EditorTokens extends HTMLElement {
	#fullTokens = null;
	#registry = null;
	#tokenStyles = null;
	#form = null;
...
customElements.define('editor-tokens', EditorTokens);
