...
This document explores various approaches for integrating the `<editor-tokens>` visual editor into a CMS, handling theme overrides, and providing real-time preview capabilities.
...
flowchart TB
    subgraph CMS["CMS (e.g., Umbraco)"]
        Editor["editor-tokens<br/>Visual Editor"]
...
sequenceDiagram
    ...
    participant CMS
    participant Editor as editor-tokens
    participant Preview
...
```javascript
// In CMS token editor
const editor = document.querySelector('editor-tokens');
...
<div class="cms-layout">
  <div class="editor-pane">
    <editor-tokens src="/api/tokens/site-a" id="editor"></editor-tokens>
  </div>
