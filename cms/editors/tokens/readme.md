...
The `<editor-tokens>` component provides a complete interface for managing design token systems. It loads W3C-compliant design tokens from JSON, generates CSS custom properties, and provides interactive editing capabilities through nested `<design-token>` components.
...
<script type="module" src="./editor-tokens/index.js"></script>
```
...
<body>
  <editor-tokens src="data/design.tokens.json"></editor-tokens>
  <script type="module" src="./editor-tokens/index.js"></script>
</body>
</html>
```
...
```javascript
const tokenViewer = document.querySelector('editor-tokens');
...
```html
<editor-tokens src="tokens.json"></editor-tokens>
```
