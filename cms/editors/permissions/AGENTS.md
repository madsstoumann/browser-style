# Editor Permissions-Policy - Internal Architecture

## Overview

Editor Permissions-Policy is a **web component for editing Permissions-Policy headers**. It provides per-feature controls organized by category (privacy, media, other) with three modes: Disabled, Self only, or Custom origins.

**Package Type:** Web Component (Custom Element)

**Tag Name:** `editor-permissions-policy`
