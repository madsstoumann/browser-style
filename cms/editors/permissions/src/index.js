...
import { adoptSharedStyles, captureOpenDetailsState, createTranslator, restoreOpenDetailsState, setState } from '@browser.style/editor-shared';
...
class EditorPermissions extends HTMLElement {
...
customElements.define('editor-permissions', EditorPermissions);
