# Editor Security - Internal Architecture

## Overview

Editor Security is a **web component for editing security.txt files** following RFC 9116. It provides a structured interface for security disclosure information with parser support for existing files.

**Package Type:** Web Component (Custom Element)

**Tag Name:** `editor-security`
...
**Lines 44-335:** `EditorSecurity extends HTMLElement`

**Registration:** Line 335: `customElements.define('editor-security', EditorSecurity);`
...
```html
<editor-security lang="en"></editor-security>

<script type="module">
  import '@browser.style/editor-security';

  const security = document.querySelector('editor-security');
...
```html
<editor-security src="/.well-known/security.txt"></editor-security>
```
