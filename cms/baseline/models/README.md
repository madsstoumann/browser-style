...
This folder contains the Unified Content Model schema definitions.
...
All schemas follow JSON Schema Draft 7 with Unified Content Model extensions:
...
Available widgets:
- `editor-card` - Content Card editor
- `editor-csp` - CSP policy editor
- `editor-manifest` - PWA manifest editor
