...
| `robots_txt` | text | <a href="https://browser.style/ui/editor-robots" target="_blank">editor-robots</a> | Full `robots.txt` content |
...
| `manifest` | object | <a href="https://browser.style/ui/editor-manifest" target="_blank">editor-manifest</a> | `manifest.json` configuration |
...
The `robots_txt` field holds the complete content of the file served at `/robots.txt`. It is edited using a visual editor (<a href="https://browser.style/ui/editor-robots" target="_blank"><code>editor-robots</code></a>) that helps construct valid directives.
...
The `manifest` field holds the JSON object served at `/manifest.json`. It is edited using a visual editor (<a href="https://browser.style/ui/editor-manifest" target="_blank"><code>editor-manifest</code></a>) that validates the structure.
